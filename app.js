...
window.data_8m = {
	...
	texts: {
		...
		section_home_es: "Página de inicio",
		section_about_us_de: "Über uns",
		section_about_us_en: "About us",
		section_about_us_es: "Sobre nosotres",
			...
			switch (window.currentLang) {
				...
				case 'es':
					containerHTML =
						...
						"<p>Bienvenides a la página web de la Alianza Feminista en Huelga de ámbito nacional. Aquí encontrarás información variada, entre otras cosas, sobre nuestros contenidos, cómo nos organizamos y cómo puedes participar activamente y trabajar en red.</p>" +
						"<p>Somos una alianza de diferentes grupos de huelga feminista y alianzas que trabajan en red en toda Alemania y de forma independiente. Somos quienes realizamos la mayor parte del trabajo de cuidados en la sociedad: crianza de los hijes, cuidado, trabajo social, trabajo sexual, cuidados emocionales y tareas domésticas; ya sea remunerado en el trabajo o no remunerado en el hogar y en el voluntariado. Experienciamos que las condiciones de estos trabajos son cada vez peores y nos acercamos cada vez más a nuestros límites, pero en lugar de compensación recibimos poco salario, nos afecta más a menudo la pobreza en la vejez y la violencia contra nosotres es cada vez peor.</p>" +
						"<p>Juntes luchamos por superar las relaciones capitalistas y patriarcales hacia una sociedad en la que la atención no se centre en obtener beneficios, sino en cuidarnos unes a otres.<br>" +
